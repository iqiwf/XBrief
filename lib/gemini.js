...
Shape:
- Mode is ${mode}. Each post must be at most ${limit} characters by X's count (URLs count as 23, other characters count as 1).
...
function userPrompt(article, issues) {
  const note = article.truncated
    ? "\nThe article text was cut at a paragraph boundary. Do not invent how it ends.\n"
    : "";
